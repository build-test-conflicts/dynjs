...
public class BasicInterpretingVisitor implements InterpretingVisitor {
  ...
  @Override public void visit(  ExecutionContext context,  OfOperatorExpression expr,  boolean strict){
    expr.getLhs().accept(context,this,strict);
    Object lhs=getValue(context,pop());
    expr.getRhs().accept(context,this,strict);
    Object rhs=getValue(context,pop());
  ...
  @Override public void visit(  ExecutionContext context,  IntegerNumberExpression expr,  boolean strict){
    push(expr.getValue());
  }
...
public BasicInterpretingVisitor(){
}
}
